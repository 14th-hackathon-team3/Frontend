...
function ProcessingStep({ onBack }) {
  return (
      ...
      >
        <div className="flex h-[32px] w-[64px] items-center">
          <button
            ...
            onClick={onBack}
            aria-label="뒤로 가기"
            className="flex h-[31px] w-[31px] items-center justify-center"
          >
            <img
              src={backButton}
              alt=""
      ...
      >
        <div className="flex w-full flex-col items-center gap-[30px]">
          ...
          <div className="relative h-[55px] w-[55px] animate-spin">
            <span className="absolute left-[22.9px] top-0 h-[9px] w-[9px] rounded-full bg-gray-300" />
            ...
            <span className="absolute bottom-0 left-[22.9px] h-[9px] w-[9px] rounded-full bg-gray-300" />
          ...
          {/* Text */}
          <div className="flex w-full flex-col gap-[10px] text-center">
