  ...
  return (
    <main className="relative mx-auto flex min-h-screen w-full max-w-[402px] flex-col bg-[#edebf5] pb-[67px]">
      ...
      <form onSubmit={(event) => { event.preventDefault(); onSave(profile); }} className="mx-auto mt-[51px] w-[341px] space-y-[29px]">
        ...
        <label className="block"><span className="text-[20px] font-semibold text-text-black">비밀번호</span><input type="password" value={profile.password} onChange={(event) => updateField('password', event.target.value)} className="mt-[14px] h-[51px] w-full rounded-[10px] border border-[#cbcbcb] bg-[#f6f6f6] px-4 text-[16px] outline-none focus:border-primary" /></label>
